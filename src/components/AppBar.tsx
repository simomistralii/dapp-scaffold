    ...
    <div>
      ...
      <div className="navbar flex h-20 flex-row md:mb-2 shadow-lg bg-black text-neutral-content border-b border-zinc-600 bg-opacity-66">
        <div className="navbar-start align-items-center">
          <div className="hidden sm:inline w-22 h-22 md:p-2 ml-10">
            <Link href="/" target="_blank" rel="noopener noreferrer" passHref className="text-secondary hover:text-white py-3">
            <img src="/nalcoin_text_logo.png" alt="image" style={{height: '4.5rem'}} />
          ...
          <WalletMultiButtonDynamic className="btn-ghost btn-sm relative flex md:hidden sm:hidden text-lg " />
        </div>
        ...
        <div className="navbar-end">
          ...
          <NavElement disabled
            ...
            navigationStarts={() => setIsNavOpen(false)}
          />
          <WalletMultiButtonDynamic className="btn-ghost btn-sm rounded-btn text-lg mr-6 " disabled />
        </div>
          <label
              htmlFor="my-drawer"
      ...
      {/* <div>
        ...
        <div className="dropdown dropdown-end">
          <div tabIndex={0} className="btn btn-square btn-ghost text-right mr-4 cursor-not-allowed">
